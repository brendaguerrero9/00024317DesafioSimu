 ...
 * @author Brenda
 */
public class FXMLPaso6Controller implements Initializable {
    
    @FXML
    public Button btnStep6;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLComponenteC.fxml"));
