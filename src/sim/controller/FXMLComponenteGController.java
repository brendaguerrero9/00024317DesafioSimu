 ...
 * @author Brenda
 */
public class FXMLComponenteGController implements Initializable {
    
    @FXML
    public Button btnStepG;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLComponenteK.fxml"));
