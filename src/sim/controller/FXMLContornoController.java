 ...
 * @author Brenda
 */
public class FXMLContornoController implements Initializable {
    
    @FXML
    public Button btnStepContor;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLDespedida.fxml"));
