 ...
 * @author Brenda
 */
public class FXMLEnsamblajeController implements Initializable {
    
    @FXML
    public Button btnStepEnsam;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLContorno.fxml"));
