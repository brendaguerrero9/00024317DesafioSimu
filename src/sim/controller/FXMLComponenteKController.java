 ...
 * @author Brenda
 */
public class FXMLComponenteKController implements Initializable {
    
    @FXML
    public Button btnStepK;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLComponenteJ.fxml"));
