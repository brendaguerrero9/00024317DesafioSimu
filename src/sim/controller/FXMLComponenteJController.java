 ...
 * @author Brenda
 */
public class FXMLComponenteJController implements Initializable {
    
    @FXML
    public Button btnStepJ;
    
    @FXML
    private void handleButtonAction(ActionEvent event) throws Exception {
        //Parent root = FXMLLoader.load(getClass().getResource("FXMLDocument.fxml"));
        Parent root = FXMLLoader.load(getClass().getResource("/sim/fxml/FXMLComponenteF.fxml"));
